...
export default function Privacy() {
  ...
  return (
    <div id="privacy-portal-page" className="min-h-screen py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[var(--background-custom,#0d0c0e)] text-white">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <div className="flex items-center gap-3 mb-8 border-b border-white/10 pb-6">
            ...
            <div>
              <span className="text-xs uppercase tracking-widest font-mono text-[var(--primary-custom,#4F46E5)] font-bold">Nucleus Protection Charter</span>
              <h1 className="text-2xl font-bold font-display mt-0.5">Privacy Policy</h1>
            </div>
          </div>

          <div id="privacy-markdown-container" className="prose prose-invert max-w-none text-white/85 leading-relaxed selection:bg-[var(--primary-custom,#4F46E5)]/30">
            <div className="markdown-body space-y-4">
              <Markdown>{settings.privacyContent}</Markdown>
            </div>
          </div>
        </motion.div>
      </div>
